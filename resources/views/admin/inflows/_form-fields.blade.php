...
<div class="space-y-4">
    <div class="grid gap-4 sm:grid-cols-2">
        <div class="vx-field">
            ...
            <input
                ...
                value="{{ old('tanggal', optional($inflow?->tanggal)->format('Y-m-d') ?? now()->format('Y-m-d')) }}"
                required
            />
        ...
        <div class="vx-field">
            ...
            <select id="{{ $prefix }}kategori" name="kategori" class="vx-select w-full" required>
                ...
                @foreach ($categories as $key => $label)
                    <option value="{{ $key }}" @selected(old('kategori', $inflow?->kategori) === $key)>{{ $label }}</option>
                @endforeach
            </select>
    ...
    <div class="vx-field">
        ...
        <input
            ...
            type="text"
            class="vx-input w-full"
            value="{{ old('nama', $inflow?->nama) }}"
            placeholder="mis. Modal sisa bulan Mei"
            required
        />
    ...
    <div class="vx-field">
        ...
        <input
            ...
            min="0"
            class="vx-input w-full"
            value="{{ old('jumlah', $inflow?->jumlah) }}"
            placeholder="0"
            required
        />
    ...
    <div class="vx-field">
        ...
        <textarea
            ...
            rows="3"
            class="vx-input w-full"
            placeholder="Opsional — mis. dipakai untuk belanja bahan baku awal bulan"
        >{{ old('catatan', $inflow?->catatan) }}</textarea>
